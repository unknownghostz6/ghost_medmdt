    ...
    methods: {
        changePage(page) {
            ...
            if (page == "Home") {
                ...
                $.post('http://ghost_medmdt/getWarrants');
        ...
        closeMDT() {
            $.post('http://ghost_medmdt/close', JSON.stringify({}));
        },
        getClass(element) {
        ...
        OffenderSearch() {
            if (this.offender_search) {
                ...
                $.post('http://ghost_medmdt/performOffenderSearch', JSON.stringify({
        ...
        OpenOffenderDetails(id) {
            for (var key in this.offender_results.results) {
                if (id == this.offender_results.results[key].id) {
                    ...
                    $.post('http://ghost_medmdt/viewOffender', JSON.stringify({
        ...
        SaveOffenderChanges() {
            $.post('http://ghost_medmdt/saveOffenderChanges', JSON.stringify({
        ...
        ReportSearch() {
            if (this.report_search) {
                ...
                $.post('http://ghost_medmdt/performReportSearch', JSON.stringify({
        ...
        SubmitNewReport() {
            if (this.report_new.title && this.report_new.char_id && this.report_new.incident) {
                $.post('http://ghost_medmdt/submitNewReport', JSON.stringify({
        ...
        SubmitNote() {
            if (this.note_new.title && this.note_new.note) {
                $.post('http://ghost_medmdt/submitNote', JSON.stringify({
        ...
        OpenOffenderDetailsById(charidentifier) {
            $.post('http://ghost_medmdt/getOffender', JSON.stringify({
        ...
        DeleteSelectedReport() {
            $.post('http://ghost_medmdt/deleteReport', JSON.stringify({
        ...
        DeleteSelectedNote() {
            $.post('http://ghost_medmdt/deleteNote', JSON.stringify({
        ...
        SaveReportEditChanges() {
            $.post('http://ghost_medmdt/saveReportChanges', JSON.stringify({
                id: this.report_selected.id,
        ...
        SaveNoteEditChanges() {
            $.post('http://ghost_medmdt/saveNoteChanges', JSON.stringify({
                id: this.note_selected.id,
        ...
        SubmitNewWarrant() {
            ...
            $.post('http://ghost_medmdt/submitNewWarrant', JSON.stringify({
        ...
        DeleteSelectedWarrant() {
            $.post('http://ghost_medmdt/deleteWarrant', JSON.stringify({
        ...
        OpenReportById(id) {
            $.post('http://ghost_medmdt/getReport', JSON.stringify({
                id: id
            }));
            this.modal = 'loading';
            return;
